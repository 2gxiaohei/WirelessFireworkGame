...
赛博烟花是一个基于STM32+ESP-01s硬件控制和Python软件显示的互动项目。通过物理按键触发，在计算机屏幕上呈现绚丽的烟花效果，实现软硬件结合的交互体验。
🎬演示视频：[【赛博烟花】](https://www.bilibili.com/video/BV1TMZDBAE8c/)
